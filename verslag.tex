...
\begin{table}
   ...
   \resizebox{\textwidth}{!}{% 
   \begin{tabular}{ll*5clc}
        \toprule
        Artikel     & Nationaliteit & \multicolumn{2}{c}{$n_{tot}$} & OR         & Follow-up        & Borstvoeding & Onderzoeksvorm & $P$-waarde\\
        \cmidrule(lr){3-4}
                    &               & $n_{borst}$                   & $n_{fles}$ & 95\% BI-interval & (jaar)       & (maand)         &  & $< 0,05$ \\
        \midrule
        Oddy1999    & Australië     &  &  & 1,25 (1,02-1,52) & 6             & 4                & Cohort studie & Waar \\
        Dekker2016  & Nederland     &  &  & 2,19 (1,29-3,71) & 6             & 2                & Cohort studie & Waar \\
        Dell2001    & Canada        &  &  & 2,39 (0,95-6,03) & *\tnote{1}    & 9                & Cohort studie & Waar \\
        Chandra1996 & Canada        &  &  & 2,37 (1,12-5,00) & 5             & 6                & RCT           & Waar \\
        \bottomrule
    \end{tabular}
}
\begin{tablenotes}
